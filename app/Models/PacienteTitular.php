...
class PacienteTitular extends Model
{
    use HasFactory;

    protected $fillable = [
        "pac_nombres", "pac_primer_apellido", "pac_segundo_apellido",
        ...
        "pac_escolaridad", "pac_f_nacimiento", "pac_tipo", "pac_cant_adicionales", "pac_parentesco"
    ];

    protected $table = "pacientetitular";
